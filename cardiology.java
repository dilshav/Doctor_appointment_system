...
public class cardiology extends JFrame {
	...
	public cardiology() {
		...
		JLabel lblNewLabel_3 = new JLabel("Dr Satheesh Chandran");
		lblNewLabel_3.setFont(new Font("Cambria", Font.PLAIN, 21));
		lblNewLabel_3.setBounds(287, 174, 248, 34);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("email- satheesh@gmail.com");
		...
		JLabel lblNewLabel_7 = new JLabel("ID-sath@123");
		lblNewLabel_7.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_7.setBounds(287, 230, 248, 34);
		contentPane.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("ID-fazal@123");
		lblNewLabel_8.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_8.setBounds(287, 449, 198, 28);
