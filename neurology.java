...
public class neurology extends JFrame {
	...
	public neurology() {
		...
		JLabel lblNewLabel = new JLabel("      NEUROLOGY");
		...
		JLabel lblNewLabel_3 = new JLabel("Dr Shamni");
		lblNewLabel_3.setFont(new Font("Cambria", Font.PLAIN, 21));
		lblNewLabel_3.setBounds(287, 174, 248, 34);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("email- shamni@gmail.com");
		...
		JLabel lblNewLabel_7 = new JLabel("ID-shamni@123");
		lblNewLabel_7.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_7.setBounds(287, 227, 207, 25);
		contentPane.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("ID-pradp@123");
		lblNewLabel_8.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_8.setBounds(285, 449, 172, 28);
