...
public class virology extends JFrame {
	...
	public virology() {
		...
		JLabel lblNewLabel = new JLabel("      VIROLOGY");
		...
		JLabel lblNewLabel_3 = new JLabel("Dr Surjith");
		lblNewLabel_3.setFont(new Font("Cambria", Font.PLAIN, 21));
		lblNewLabel_3.setBounds(287, 174, 248, 34);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("email- surithj@gmail.com");
		...
		JLabel lblNewLabel_5 = new JLabel("Dr Bipin Chandra");
		lblNewLabel_5.setFont(new Font("Cambria", Font.PLAIN, 21));
		lblNewLabel_5.setBounds(287, 388, 248, 34);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("email- bipin@gmail.com");
		...
		JLabel lblNewLabel_7 = new JLabel("ID-surj@123");
		lblNewLabel_7.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_7.setBounds(287, 238, 205, 25);
		contentPane.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("ID-Bipin@123");
		lblNewLabel_8.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_8.setBounds(287, 449, 193, 25);
