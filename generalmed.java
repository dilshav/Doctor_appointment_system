...
public class generalmed extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					generalmed frame = new generalmed();
	...
	public generalmed() {
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\91964\\eclipse-workspace\\Swing\\src\\image\\male (1).jpg"));
		...
		JLabel lblNewLabel_3 = new JLabel("Dr Raveendran");
		lblNewLabel_3.setFont(new Font("Cambria", Font.PLAIN, 21));
		lblNewLabel_3.setBounds(287, 174, 248, 34);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("email- raveendran@gmail.com");
		...
		JLabel lblNewLabel_7 = new JLabel("ID-raveen@123");
		lblNewLabel_7.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_7.setBounds(287, 234, 240, 25);
		contentPane.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("ID-fahiba@123");
		lblNewLabel_8.setFont(new Font("Cambria", Font.PLAIN, 18));
		lblNewLabel_8.setBounds(287, 449, 201, 25);
